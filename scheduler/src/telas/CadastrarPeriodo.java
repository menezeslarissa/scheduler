...
public class CadastrarPeriodo extends javax.swing.JFrame {
    ...
    public CadastrarPeriodo(ControlePeriodo controlePeriodo) {
    ...
    private void initComponents() {
        ...
        cbAno.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2018\t", "2019", "2020", "2021", "2022" }));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText(".");

        cbSemestre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "01", "02" }));
    ...
    private void salvarCadastro() {
        String periodoStr = cbAno.getSelectedItem().toString().trim() + '.' + cbSemestre.getSelectedItem().toString();
        Periodo p = new Periodo();
        p.setPeriodo(periodoStr);
   
        if(!this.controlePeriodo.salvar(p))
        {
           JOptionPane.showMessageDialog(this, "Inclusão cancelada. Período selecionado já cadastrado.", "Scheduler",JOptionPane.ERROR_MESSAGE);
        }
        else
        {
            JOptionPane.showMessageDialog(this, "Período cadastrado com sucesso.", "Scheduler",JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        }  
    }
