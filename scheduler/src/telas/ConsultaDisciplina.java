...
import tableModel.TableModelDisciplina;
...
public class ConsultaDisciplina extends javax.swing.JFrame {
    ...
    public ConsultaDisciplina(ControleLogin controleLogin) throws ParseException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Scheduler - Controle de Disciplinas");
        setResizable(false);
        ...
        btNovo.setText("   Novo");
        btNovo.setToolTipText("Nova Disciplina");
        ...
        tabelaDisciplinas.setToolTipText("Editar Disciplina");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(edFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
        CadastrarDisciplina tela = new CadastrarDisciplina(this.controleDisciplina,'C');
        tela.setVisible(true);
    }//GEN-LAST:event_btNovoActionPerformed

    private void selecionarDisciplina() {
        try {
            controleDisciplina.setDisciplina(controleDisciplina.listar(edFiltro.getText()).get(linhaSelecionada));
    ...
    private void tabelaDisciplinasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaDisciplinasMouseClicked
        ...
        new CadastrarDisciplina(controleDisciplina,'A').setVisible(true);
